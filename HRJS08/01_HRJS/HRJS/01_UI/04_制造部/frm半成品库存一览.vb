...
#Region "Button Event"
    ...
    Private Sub txt客户编号_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txt客户编号.Leave
        Dim objM客户T As M客户T
        ...
        Try
            ...
            If Me.txt客户编号.Text.Trim <> String.Empty Then
                ...
                If objM客户T.客户名称 <> String.Empty Then
                    ...
                    Me.txt客户名称.Text = objM客户T.客户名称     '客户名称
...
#Region "InitGrid"
    ...
    Private Sub InitGrid()
        Try
            ...
            mdt详细Band0.Columns.Add("主图号")
            mdt详细Band0.Columns.Add("上级图号")
            mdt详细Band0.Columns.Add("分图号")
            mdt详细Band0.Columns.Add("产品名称")
            mdt详细Band0.Columns.Add("工序名称")
            mdt详细Band0.Columns.Add("库存数量")
            mdt详细Band0.Columns.Add("半成品种类")
...
#Region "DataSearch"
    ...
    Private Sub Selection()
        ...
        Try
            ...
            '查询の选择されたレCDを取得する
            objB外协品库存T.订单编号 = Me.grdList.ActiveRow.Cells("订单编号").Value
            objB外协品库存T.主图号 = Me.grdList.ActiveRow.Cells("主图号").Value
            objB外协品库存T.上级图号 = Me.grdList.ActiveRow.Cells("上级图号").Value
            objB外协品库存T.产品图号 = Me.grdList.ActiveRow.Cells("分图号").Value
            objB外协品库存T.外协工序 = Me.grdList.ActiveRow.Cells("工序编号").Value

            'テーブルにデータを追加
            ReturnTable = objBLLM外协品库存T.LoadAllB(objB外协品库存T)
