...
Partial Class frm外协对象一览
    ...
    Private Sub InitializeComponent()
        ...
        Dim UltraGridColumn1 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("外协对象编号")
        Dim UltraGridColumn2 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("外协对象名称")
        ...
        Dim UltraGridColumn8 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("交货方式")
        Dim UltraGridColumn9 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("税率")
        ...
        Me.txt外协对象编号 = New UserControl.UCText(Me.components)
        ...
        CType(Me.txt外协对象编号, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.UcGroupBox1.Controls.Add(Me.txt外协对象名称)
        Me.UcGroupBox1.Controls.Add(Me.UcLabel2)
        Me.UcGroupBox1.Controls.Add(Me.UcLabel4)
        Me.UcGroupBox1.Controls.Add(Me.txt外协对象编号)
        ...
        Me.txt外协对象名称.Location = New System.Drawing.Point(106, 44)
        Me.txt外协对象名称.MaxLength = 50
        Me.txt外协对象名称.Name = "txt外协对象名称"
        Me.txt外协对象名称.Size = New System.Drawing.Size(134, 23)
        Me.txt外协对象名称.TabIndex = 9
        '
        'UcLabel2
        '
        ...
        Me.UcLabel4.Text = "外协对象编号"
        '
        'txt外协对象编号
        '
        Me.txt外协对象编号.AutoSize = False
        Me.txt外协对象编号.IsDigit = False
        Me.txt外协对象编号.Location = New System.Drawing.Point(106, 21)
        Me.txt外协对象编号.MaxLength = 50
        Me.txt外协对象编号.Name = "txt外协对象编号"
        Me.txt外协对象编号.Size = New System.Drawing.Size(134, 23)
        Me.txt外协对象编号.TabIndex = 7
        '
        'grdList
        '
        ...
        CType(Me.txt外协对象编号, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents txt外协对象编号 As UserControl.UCText
