...
#Region "Form Event"
    ...
    Private Sub frm产品种类详细_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
        ...
        End Try
    End Sub
    Private Sub frm产品种类详细_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
        ...
        End Try
    End Sub
    Private Sub frm产品种类查询_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        Try
            ...
            If frmSearch.ReturnType = Constant.ENU_MSTSEARCH.SearchMOk Then
                ...
                If Not frmSearch.ReturnTable Is Nothing AndAlso 0 < frmSearch.ReturnTable.Rows.Count Then
                    ...
                    Me.txt产品种类编号.Text = frmSearch.ReturnTable.Rows(0)("产品种类编号").ToString          '产品种类编号
                    Me.txt产品种类名称.Text = frmSearch.ReturnTable.Rows(0)("产品种类名称").ToString          '产品种类名称
    ...
    Private Sub btnF4删除_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnF4删除.Click
        ...
        Try
            ...
            If Me.txt产品种类编号.Text.Trim = String.Empty Then
                CommonMsg.PFn_ShowMsg(Me.Text, Constant.ENU_MSGID.MSGID13, "产品种类编号", "产品种类编号")
                txt产品种类编号.Focus()
                Exit Sub
            End If
            ...
            If objBll.Delete(objM产品种类T) > 0 Then
...
#Region "SaveData"
    ...
    Private Sub SaveData()
        ...
        Try
            ...
            objM产品种类T.产品种类编号 = txt产品种类编号.Text.Trim
            objM产品种类T.产品种类名称 = txt产品种类名称.Text.Trim

            Select Case mIntFormMode

                Case Constant.ENU_MODE.Model_New

                    If objBll.LoadByPKey(objM产品种类T).产品种类编号 <> String.Empty Then

                        CommonMsg.PFn_ShowMsg(Me.Text, Constant.ENU_MSGID.MSGID21, "产品种类编号")
                        Me.txt产品种类编号.Select()
                        '処理終了
                        Exit Sub
                    ...
                    If objBll.Insert(objM产品种类T) > 0 Then
                ...
                Case Constant.ENU_MODE.Model_Update
                    ...
                    If objBll.Update(objM产品种类T) > 0 Then
...
#Region "InputCheck"
    ...
    Private Function InputCheck() As Boolean
        ...
        Try
            ...
            If Me.txt产品种类名称.Text.Trim = String.Empty Then
                CommonMsg.PFn_ShowMsg(Me.Text, Constant.ENU_MSGID.MSGID13, "产品种类名称", "产品种类名称")
                txt产品种类名称.Focus()
                Return False
            End If
