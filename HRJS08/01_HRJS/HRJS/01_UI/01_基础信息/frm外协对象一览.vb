...
Imports UserControl
Public Class frm外协对象一览

#Region "变量定义"
    Private mDtSearch As DataTable = Nothing
    Private mstr外协对象编号 As String = String.Empty
    Private mstr外协对象名称 As String = String.Empty
...
#Region "Form Event"
    ...
    Private Sub frm外协对象一览_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Try
...
#Region "InitGrid"
    ...
    Private Sub InitGrid()
        Try
            ...
            mDtSearch.Columns.Add("外协对象编号")
            mDtSearch.Columns.Add("外协对象名称")
...
#Region "ClearForm"
    ...
    Private Sub ClearForm()
        Try
            ...
            txt外协对象编号.Text = String.Empty
            txt外协对象名称.Text = String.Empty
...
#Region "Selection"
    ...
    Private Sub Selection()
        ...
        Try
            ...
            '查询の选择されたレCDを取得する
            objM外协对象T.外协对象编号 = Me.grdList.ActiveRow.Cells("外协对象编号").Text.Trim

            'テーブルにデータを追加
            ReturnTable = objBll.LoadInfoCD(objM外协对象T)
...
#Region "DataSearch"
    ...
    Private Sub DataSearch()
        ...
        Try
            ...
            objM外协对象T.外协对象名称 = Me.txt外协对象名称.Value

            '查询の検索処理
            mDtSearch = objBll.LoadByWhere(objM外协对象T)
