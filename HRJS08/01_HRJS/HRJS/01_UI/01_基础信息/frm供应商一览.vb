...
Imports UserControl
Public Class frm供应商一览
#Region "变量定义"
    Private mDtSearch As DataTable = Nothing
    Private mstr供应商编号 As String = String.Empty
...
#Region "Form Event"
    ...
    Private Sub frm供应商一览_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
...
#Region "Selection"
    ...
    Private Sub Selection()
        ...
        Try
            ...
            '查询の选择されたレCDを取得する
            objM供应商T.供应商编号 = Me.grdList.ActiveRow.Cells("供应商编号").Text.Trim
           
            'テーブルにデータを追加
            ReturnTable = objBll.LoadInfoCD(objM供应商T)
...
#Region "DataSearch"
    ...
    Private Sub DataSearch()
        ...
        Try
            ...
            objM供应商T.供应商名称 = Me.txt供应商名称.Value

            '查询の検索処理
            mDtSearch = objBll.LoadByWhere(objM供应商T)
