...
#Region "変数定義"
    ...
    Private mstr货位编号 As String = String.Empty
...
#Region "Form Event"
    ...
    Private Sub frm货位一览_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Try
        ...
        End Try
    End Sub
    Private Sub frm货位一览_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
        ...
        End Try
    End Sub
    Private Sub frm货位一览_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
...
#Region "ClearForm"
    ...
    Private Sub ClearForm()
        Try
            ...
            txt货位名称.Text = String.Empty
            txt货位编号.Text = String.Empty
...
#Region "InitGrid"
    ...
    Private Sub InitGrid()
        Try
            ...
            mDtSearch.Columns.Add("货位编号")
            mDtSearch.Columns.Add("货位名称")
...
#Region "Selection"
    ...
    Private Sub Selection()
        ...
        Try
            ...
            '查询の选择されたレCDを取得する
            objM货位T.货位编号 = Me.grdList.ActiveRow.Cells(ENU_GRID.货位编号).Text.Trim

            'テーブルにデータを追加
            ReturnTable = objBll.LoadAll(objM货位T)
...
#Region "DataSearch"
    ...
    Private Sub DataSearch()
        ...
        Dim objBllM货位T As New BLLM货位T

        Try
            objM货位T = New M货位T

            objM货位T.货位编号 = Me.txt货位编号.Value
            objM货位T.货位名称 = Me.txt货位名称.Text.Trim

            '查询の検索処理


            mDtSearch = objBllM货位T.LoadByWhere(objM货位T)
            ...
            'dtCOUNT = objBllM货位T.GetGridData(objM货位T, True)
