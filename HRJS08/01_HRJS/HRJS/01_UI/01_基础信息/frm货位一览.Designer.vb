...
Partial Class frm货位一览
    ...
    Private Sub InitializeComponent()
        ...
        Dim UltraGridColumn1 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("货位编号")
        Dim UltraGridColumn2 As Infragistics.Win.UltraWinGrid.UltraGridColumn = New Infragistics.Win.UltraWinGrid.UltraGridColumn("货位名称")
        ...
        Me.btnF2查询.Tag = "100201"
        '
        'btnF3选择
        '
        Me.btnF3选择.TabIndex = 4
        Me.btnF3选择.Tag = "100202"
        '
        'btnF1清空
        '
        ...
        Me.txt货位名称.Location = New System.Drawing.Point(106, 44)
        Me.txt货位名称.MaxLength = 50
        Me.txt货位名称.Name = "txt货位名称"
        Me.txt货位名称.Size = New System.Drawing.Size(134, 23)
        ...
        Me.UcLabel4.Text = "货位编号"
        '
        'txt货位编号
        '
        Me.txt货位编号.AutoSize = False
        Me.txt货位编号.IsDigit = False
        Me.txt货位编号.Location = New System.Drawing.Point(106, 21)
        Me.txt货位编号.MaxLength = 50
        Me.txt货位编号.Name = "txt货位编号"
        Me.txt货位编号.Size = New System.Drawing.Size(134, 23)
