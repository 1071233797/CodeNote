...
#Region "Form Event"
    ...
    Private Sub frm成品入库质检一览_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub frm成品入库质检一览_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        Try
    ...
    Private Sub frm成品入库质检一览_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        Try
            ...
            If frmSearch.ReturnType = Constant.ENU_MSTSEARCH.SearchMOk Then
                ...
                If Not frmSearch.ReturnTable Is Nothing AndAlso 0 < frmSearch.ReturnTable.Rows.Count Then
                    ...
                    Me.txt入库申请单.Text = frmSearch.ReturnTable.Rows(0)("申请单编号")     '申请
...
#Region "Selection"
    ...
    Private Sub Selection()
        ...
        Try
            ...
            '查询の选择されたレCDを取得する
            objZ成品入库质检T.申请单编号 = Me.gridList.ActiveRow.Cells("申请单编号").Text.Trim

            'テーブルにデータを追加
            ReturnTable = objBll.LoadAllHead(objZ成品入库质检T)
...
#Region "DataSearch"
    ...
    Private Sub DataSearch()
        ...
        Try
            objB成品入库质检T = New Z成品入库质检T

            'objB原材料入库申请T.材料编号 = Me.txt原材料编号.Text
            objB成品入库质检T.检查者编号 = Me.txt人员编号.Text
            objB成品入库质检T.申请单编号 = Me.txt入库申请单.Text.Trim
            objB成品入库质检T.处理结果 = Me.cmb处理结果.Value
            objB成品入库质检T.检查日期1 = Me.dt检查日期S.Text
            objB成品入库质检T.检查日期2 = Me.dt检查日期E.Text

            Me.gridList.DataSource = Nothing

            Me.mDtSearch = New DataTable
            mDtSearch = objBll.LoadByWhere(objB成品入库质检T)
    ...
    Private Sub SetGridStyle()
        Try
            ...
            With gridList.DisplayLayout.Bands(0)
                ...
                .Columns("申请单编号").CellActivation = Infragistics.Win.UltraWinGrid.Activation.NoEdit
