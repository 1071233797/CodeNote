...
Partial Public Class 半成品
    ...
    Private Sub InitializeComponent()
        Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(半成品))
        ...
        Me.txt主图号 = New DataDynamics.ActiveReports.TextBox
        Me.txt分图号 = New DataDynamics.ActiveReports.TextBox
        Me.txt半成品种类 = New DataDynamics.ActiveReports.TextBox
        ...
        CType(Me.txt半成品种类, System.ComponentModel.ISupportInitialize).BeginInit()
        ...
        Me.PageHeader1.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.Line1, Me.Line2, Me.Line3, Me.Line4, Me.Label1, Me.Label2, Me.Label3, Me.Label4, Me.Label5, Me.txt订单编号, Me.txt主图号, Me.txt分图号, Me.txt半成品种类, Me.txt库存区域, Me.bar详细})
        ...
        'txt主图号
        '
        Me.txt主图号.Border.BottomColor = System.Drawing.Color.Black
        Me.txt主图号.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt主图号.Border.LeftColor = System.Drawing.Color.Black
        Me.txt主图号.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt主图号.Border.RightColor = System.Drawing.Color.Black
        Me.txt主图号.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt主图号.Border.TopColor = System.Drawing.Color.Black
        Me.txt主图号.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt主图号.Height = 0.1979167!
        Me.txt主图号.Left = 1.0625!
        Me.txt主图号.Name = "txt主图号"
        Me.txt主图号.Style = ""
        Me.txt主图号.Text = "TextBox1"
        Me.txt主图号.Top = 0.4375!
        Me.txt主图号.Width = 1.0!
        '
        'txt分图号
        '
        Me.txt分图号.Border.BottomColor = System.Drawing.Color.Black
        Me.txt分图号.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt分图号.Border.LeftColor = System.Drawing.Color.Black
        Me.txt分图号.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt分图号.Border.RightColor = System.Drawing.Color.Black
        Me.txt分图号.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt分图号.Border.TopColor = System.Drawing.Color.Black
        Me.txt分图号.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt分图号.Height = 0.1979167!
        Me.txt分图号.Left = 1.0625!
        Me.txt分图号.Name = "txt分图号"
        Me.txt分图号.Style = ""
        Me.txt分图号.Text = "TextBox1"
        Me.txt分图号.Top = 0.6875!
        Me.txt分图号.Width = 1.0!
        '
        'txt半成品种类
        '
        Me.txt半成品种类.Border.BottomColor = System.Drawing.Color.Black
        Me.txt半成品种类.Border.BottomStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt半成品种类.Border.LeftColor = System.Drawing.Color.Black
        Me.txt半成品种类.Border.LeftStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt半成品种类.Border.RightColor = System.Drawing.Color.Black
        Me.txt半成品种类.Border.RightStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt半成品种类.Border.TopColor = System.Drawing.Color.Black
        Me.txt半成品种类.Border.TopStyle = DataDynamics.ActiveReports.BorderLineStyle.None
        Me.txt半成品种类.Height = 0.1979167!
        Me.txt半成品种类.Left = 1.0625!
        Me.txt半成品种类.Name = "txt半成品种类"
        Me.txt半成品种类.Style = ""
        Me.txt半成品种类.Text = "TextBox1"
        Me.txt半成品种类.Top = 0.9375!
        Me.txt半成品种类.Width = 1.0!
        '
        'txt库存区域
        '
        ...
        CType(Me.txt半成品种类, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents txt主图号 As DataDynamics.ActiveReports.TextBox
    Friend WithEvents txt分图号 As DataDynamics.ActiveReports.TextBox
    Friend WithEvents txt半成品种类 As DataDynamics.ActiveReports.TextBox
