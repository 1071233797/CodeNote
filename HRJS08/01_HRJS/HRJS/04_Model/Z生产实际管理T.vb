Public Class Z生产实际管理T
    ...
    Private _str作业日期sta As String = String.Empty
    Private _str作业日期end As String = String.Empty
    ...
    Private _str作业者编号 As String = String.Empty
    Private _str本道工序编号 As String = String.Empty
    Private _str本道工序 As String = String.Empty
    ...
    Private _str计划生产数 As String = String.Empty
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property 作业者编号() As String
        Get
            Return _str作业者编号
    ...
    Public Property 作业指示() As String
        ...
        End Set
    End Property
    Public Property 作业日期sta() As String
        Get
            Return _str作业日期sta
        ...
        End Set
    End Property
    Public Property 作业日期end() As String
        Get
            Return _str作业日期end
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property 本道工序() As String
        Get
            Return _str本道工序
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Property 计划生产数() As String
        Get
            Return _str计划生产数
